...
public class VistaController {
    ...
    public void menuCalibracion2() { //Menu 19
        ...
        taPantalla.appendText("3=LISTAR NOMBRES             4=CAMBIAR PAGINA"); // 2 nos lleva al menú 23 y 4 al menú 20
    }
    ...
    public void menuCalibracion3() { //Menu 20
        ...
        taPantalla.appendText("3=LISTAR NOMBRES             4=CAMBIAR PAGINA"); // 2 nos lleva al menú 23 y 4 al menú 21
    }
    ...
    public void menuCalibracion4() { //Menu 21
        ...
        taPantalla.appendText("3=LISTAR NOMBRES             4=CAMBIAR PAGINA"); // 2 nos lleva al menú 23 y 4 al menú 22
    }
    ...
    // Devuelve el puerto que se usa para enviar o recibir
    public Puerto getPuerto() {
        return puerto;
    }
    
    // Recibe las pulsaciones del teclado enviadas por el usuario y según la posición del menú lanza un método u otro
    ...
    public void inicioEquipo(byte[] array) {//Menu 1
        if (array[0] == 0x0d) { // Solo si se recibe pulsacion ENTER
