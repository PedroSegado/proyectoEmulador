...
/**
 * Clase principal que inicia el programa donde se muestra una emulación del equipo OXFORD LAB-X3500 y lo que se
 * mostraría en su pantalla trasn recibir unos determinados datos a traves del puerto COM
 *
...
public class Main extends Application {
    ...
    private static ArrayList<Calibrado> listaCal = new ArrayList(); // Almacenará los 3 calibrados de prueba
